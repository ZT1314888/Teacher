...
# Redis 缓存配置
USE_REDIS = config('USE_REDIS', default=False, cast=bool)  # 临时使用内置内存缓存，避免缺少 django-redis 报错
...
SIMPLEUI_HOME_INFO = False  # 关闭首页的快捷操作和最近动作信息
SIMPLEUI_ANALYSIS = False  # 关闭使用分析
SIMPLEUI_HOME_QUICK = False  # 关闭首页快捷操作
SIMPLEUI_HOME_ACTION = False  # 关闭首页最近动作
